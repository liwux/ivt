...
exports.applicationId='8M7zAVBnDepHxnJIcIJkYLuN-gzGzoHsz';
exports.applicationKey='cyuK7XePPspGzwWrs12bf5uc';

//express用做加密token的salt，自己申请应用搭建时，可稍微更改字符串，可以更安全
exports.cookieParserSalt="klp4e8b4sddjp2";

//mailGun，一个邮箱服务提供商，当有新工单创建或有回复的时候用到
exports.mailGunKey='hanxx@inno-view.cn';//please use your mailGunKey
...
//配置自己申请的子域名
exports.hostUrl='http://ivt.leanapp.cn/';

//邮件的发送者，平时管理员回复了你的工单的时候，你便会收到来自这个邮箱的email
exports.emailHost='hanxx@inno-view.cn';
